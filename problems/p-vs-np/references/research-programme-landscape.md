...
This document records the major research programmes relevant to P versus NP and explains how this repository uses concrete testbeds. It is complete at the level of major paradigms, not every circuit class, proof system, parameter, or paper.

All identifiers resolve through the [canonical source map](top-level-landscape-sources.md).
...
3. Separate encoded-input polynomial time from pseudopolynomial, parameterized, average-case, promise, randomized, or heuristic performance.
...
| Promise/totality confusion | Promise and total-search problems have different quantifiers from NP decision languages | `[P26]`, `[P58]` |
