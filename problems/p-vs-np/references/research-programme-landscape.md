...
| `B03` | Arithmetic circuit lower bounds | Prove superpolynomial lower bounds for explicit polynomials such as the permanent | Stronger lower bounds and richer algebraic tools than in the Boolean setting | Known rank, shifted-partial-derivative, and geometric techniques have their own barriers | Permanent versus determinant, polynomial identity testing | Separate but strategically connected programme | `[P16]`, `[P17]` |
