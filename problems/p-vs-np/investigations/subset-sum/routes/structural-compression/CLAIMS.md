...
| `SS-SC-005` | Subset Sum is polynomial-time decidable on any class admitting an efficiently constructible, polynomially bounded exact decomposition with a strictly decreasing polynomially bounded measure. | `PROVED` | `CHECKED` | [Bounded decomposition class](proofs/polynomially-bounded-decomposition-class.md) | `SS-004` | 2026-07-16 |

## Final disposition

The route is closed as a universal polynomial-time strategy. `SS-SC-002` and `SS-SC-005` remain valid local and conditional results.
